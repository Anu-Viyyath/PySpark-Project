...
<div class="title">
<tr>
<td colspan=2><center><font size=4><b><h1>Choose your CSV file</h1></b></font></center></td>
</tr>



  <form action=""> <center>                                                                                                                                                                                                                                                           
    <button type="choose" class="btn btn-primary btn-block btn-large" width=40%>Choose</button>
   </form>  

<tr>
<td colspan=2><center><font size=4><input type="text"  name="database"  placeholder="file location"></font></center></td>
</tr>

<form action=""> <center>                                                                                                                                                                                                                                                             
      <button type="submit" class="btn btn-primary btn-block btn-large width=40%">Submit</button></center>
 </form>  
  <h3>
