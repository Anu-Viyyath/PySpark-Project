  ...
  <form action=""> <center>                                                                                                                                                                                                                                                           
    <script type="text/javascript">
        ...
        function UploadWindow(URL) {
                 ...
                 var Upload = window.open(URL,"",

"toolbar=0,scrollbars=0,location=0,statusbar=0,menubar=0,resizable=0,width=430,height=50");
...
<form action=""> <center>                                                                                                                                                                                                                                                             
      <button type="button"onclick="myFunction()" class="btn btn-primary btn-block btn-large width=40%">Submit</button></center>
 </form>  
  <h3>
